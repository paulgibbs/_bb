...
class phpBB extends BB_Converter_Base {
	...
	public function setup_globals() {
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_bb_phpbb_user_icq'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_bb_phpbb_user_msnm'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_bb_phpbb_user_occ'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_bb_phpbb_user_interests'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_bb_phpbb_user_sig',
			'callback_method' => 'callback_html'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_bb_phpbb_user_from'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_bb_phpbb_user_avatar'
		);
