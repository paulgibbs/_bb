...
class Example_Converter extends BB_Converter_Base
{
	...
	public function setup_globals()
	{
		...
		$this->field_map[] = array(
			...
			'to_type' => 'topic', 'to_fieldname' => '_bb_topic_id'
		);
		
		// Forum id. Stored in postmeta.
		$this->field_map[] = array(
			'from_tablename' => 'thread', 'from_fieldname' => 'forumid',
			'to_type' => 'topic', 'to_fieldname' => '_bb_forum_id',
		...
		$this->field_map[] = array(
			...
			'to_type' => 'reply', 'to_fieldname' => '_bb_post_id'
		);
		
		// Forum id. Stores in postmeta.
		$this->field_map[] = array(
			'from_tablename' => 'post', 'from_fieldname' => 'threadid',
			'to_type' => 'reply', 'to_fieldname' => '_bb_forum_id',
		...
		$this->field_map[] = array(
			'from_tablename' => 'post', 'from_fieldname' => 'threadid',
			'to_type' => 'reply', 'to_fieldname' => '_bb_topic_id',
			'callback_method' => 'callback_topicid'
		);
		...
		$this->field_map[] = array(
			...
			'to_type' => 'reply', 'to_fieldname' => '__bb_author_ip'
		);	
		...
		$this->field_map[] = array(
			'to_type' => 'user', 'to_fieldname' => '_bb_class',
			'default' => 'Vbulletin'
		);
